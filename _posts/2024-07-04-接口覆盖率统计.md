...
# 一、方法覆盖率
<span style="color:red;font-size: 24px;">方法覆盖率 = 被覆盖的接口数量 / 接口总数</span>
...
# 二、行覆盖率
<span style="color:red;font-size: 24px;">行覆盖率 = 被覆盖的行数量 / 代码总行数</span>
...
# 三、区域覆盖率
<span style="color:red;font-size: 24px;">区域覆盖率 = 实际被覆盖的区域数量 / 总区域数量
</span>
...
# 四、分支覆盖率
<span style="color:red;font-size: 24px;">分支覆盖率 = 已执行分支数 / 分支总数</span>
